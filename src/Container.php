...
if (interface_exists('\Psr\Container\NotFoundExceptionInterface')) {
    class EntryNotFoundException extends \Exception implements \Psr\Container\NotFoundExceptionInterface
    {}
} else {
...
if (interface_exists('\Psr\Container\ContainerExceptionInterface') &&
    class_exists('BindingResolutionException') &&
    is_subclass_of('BindingResolutionException', '\Psr\Container\ContainerExceptionInterface')) {
    class BindingResolutionException extends BindingResolutionException
    {}
} elseif (!interface_exists('\Psr\Container\ContainerExceptionInterface') &&
    class_exists('BindingResolutionException')) {
    class BindingResolutionException extends BindingResolutionException
    {}
} elseif (interface_exists('\Psr\Container\ContainerExceptionInterface')) {
    class BindingResolutionException extends \Exception implements \Psr\Container\ContainerExceptionInterface
    {}
} else {
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    public function wrap(Closure $callback, array $parameters = array())
    {
        ...
        return function () use ($callback, $parameters, $me) {
            return $me->call($callback, $parameters);
        };
    }
    ...
    public function factory($abstract)
    {
        ...
        return function () use ($abstract, $me) {
            return $me->make($abstract);
        };
    }
